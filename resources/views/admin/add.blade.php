...
@section('content')
	...
	<div class="content-contain">
		...
		<form class="addreview-form" action="add" method="post">
			{!! csrf_field() !!}
			<div class="mdl-textfield mdl-js-textfield">
			    <input class="mdl-textfield__input" name="title" type="text" id="title" value="{{ old('title') }}" maxlength="70">
		    ...
		    <label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect" for="extended">
				<input name="extended" type="checkbox" id="extended" class="mdl-checkbox__input" value="extended" @if(old('extended')=="extended") checked @endif>
				<span class="mdl-checkbox__label">Extended review</span>
			</label>

		    <div class="addreview-content--extended">
			    <textarea name="content" type="text" class="addreview-content--extended__textarea">{{ old('content') }}</textarea>
			...
			<label for="rating">Rating</label>
		 	<p class="formslider">
		 		<input class="mdl-slider mdl-js-slider" name="rating" type="range" min="0" max="10" tabindex="0" id="rating" value="{{ old('rating') }}">
		 	</p>
			...
			<a href="{{ url('/shows') . '/' . $show->id }}" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect no-linkstyle formbutton formbutton-back">Go back</a>
